...
const TrackOrder:React.FC<TrackOrderPropsInterce>= ({orderStatus}) => {
  ...
  return (
         <ul id="progressbar-1" className="mx-0 mt-3 pb-3 col-12  px-0 pt-0 d-sm-flex  w-100 " >
                ...
                <li className={`step0 text-muted ${completed} text-end mt-sm-0 mt-3 `} id="step4"><span style={{  }}>completed</span></li>
          </ul>
  )
}
